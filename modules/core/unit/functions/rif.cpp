...
// NT2_TEST_CASE_TPL( rif_value_type, NT2_TYPES )
// {
//   using boost::mpl::_;
//   using nt2::meta::value_type_;

//   NT2_TEST_EXPR_TYPE( (nt2::rif(4,4))
//                      , (value_type_<_>)
//                      , (double)
//                      );
//   NT2_TEST_EXPR_TYPE( (nt2::rif(4, 4,nt2::meta::as_<T>()))
//                      , (value_type_<_>)
//                      , (T)
//                      );
//   NT2_TEST_EXPR_TYPE( (nt2::rif(nt2::of_size(4,4)))
//                     , (value_type_<_>)
//                     , (double)
//                     );

//   NT2_TEST_EXPR_TYPE( (nt2::rif(nt2::of_size(4,4),nt2::meta::as_<T>()))
//                     , (value_type_<_>)
//                     , (T)
//                     );
// }
 ...
 NT2_TEST_CASE( rif_nd_untyped )
 {
   ...
   for(int i=0;i<3;++i) for(int j=0;j<3;++j)NT2_TEST_EQUAL( double(i), double(x1(i, j)) );
   for(int i=0;i< 3;++i) {
     for(int j=0;j< 3;++j){
   ...
   for(int i=1;i<=8;++i) for(int j=1;j<=6;++j)NT2_TEST_EQUAL( double(i), double(x6(i, j)) );
...
NT2_TEST_CASE( rif_expr )
{
  ...
  nt2::table<double> x1 = nt2::rif( nt2::size(a) );
  for(int i=1;i<=4;++i) for(int j=1;j<=5;++j) NT2_TEST_EQUAL(  double(i), double(x1(i, j)) );
