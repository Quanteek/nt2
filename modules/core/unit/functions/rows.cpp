...
// NT2_TEST_CASE_TPL( rows_value_type, NT2_TYPES )
// {
//   using boost::mpl::_;
//   using nt2::meta::value_type_;

//   NT2_TEST_EXPR_TYPE( (nt2::rows(4,4))
//                      , (value_type_<_>)
//                      , (double)
//                      );
//   NT2_TEST_EXPR_TYPE( (nt2::rows(4, 4,nt2::meta::as_<T>()))
//                      , (value_type_<_>)
//                      , (T)
//                      );
//   NT2_TEST_EXPR_TYPE( (nt2::rows(nt2::of_size(4,4)))
//                     , (value_type_<_>)
//                     , (double)
//                     );

//   NT2_TEST_EXPR_TYPE( (nt2::rows(nt2::of_size(4,4),nt2::meta::as_<T>()))
//                     , (value_type_<_>)
//                     , (T)
//                     );
// }
