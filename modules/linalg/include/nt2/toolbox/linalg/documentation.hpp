...
/*!
 * \ingroup toolbox
 * \defgroup linalg linalg functions
 * \brief Defines linalg functions
 **/
/*!
 * \ingroup linalg
 * \defgroup linalg
 * \brief Defines linalg
 **/
/*
  The linalg interface is based on 6 levels of interface from external
