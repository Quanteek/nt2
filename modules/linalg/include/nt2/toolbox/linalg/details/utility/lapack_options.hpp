 ...
 ******************************************************************************/
#ifndef NT2_TOOLBOX_LINALG_DETAILS_UTILITY_LAPACK_OPTIONS_HPP_INCLUDED
#define NT2_TOOLBOX_LINALG_DETAILS_UTILITY_LAPACK_OPTIONS_HPP_INCLUDED
...
//     }
    ...
    class lapack_options{
    public:
      lapack_options(bool trans =  false):
        lt(false),
        ut(false),
        uhess(false),
        sym(false),
...
//      template < class XPR > 
//       lapack_options(const expression < XPR > &a, bool trans)//:
//        lt(istril(a)),
//         ut(!lt && istriu(a)),
//         uhess(!ut && isuhess(a)),
//         sym(!ut && issym(a)),
