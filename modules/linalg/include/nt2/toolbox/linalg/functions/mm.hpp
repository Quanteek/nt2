 ...
 * \file
**/
#ifndef NT2_TOOLBOX_LINALG_FUNCTIONS_MM_HPP_INCLUDED
#define NT2_TOOLBOX_LINALG_FUNCTIONS_MM_HPP_INCLUDED

#include <nt2/include/functor.hpp>

/*!
 * \ingroup linalg
 * \defgroup linalg_mm mm
 *
 * \par Description
...
namespace nt2 { namespace tag
  {         
     ...
     *        in namespace nt2::tag for toolbox linalg
    **/
