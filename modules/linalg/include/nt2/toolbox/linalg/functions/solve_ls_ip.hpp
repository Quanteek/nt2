...
namespace nt2 { namespace tag
  {         
    /*!
     * \brief Define the tag solve_lse_ip_ of functor lse
  ...
  BOOST_FORCEINLINE nt2::solve_lse_ip_return<A, B, C, D> lse(A &a, B& b, C& c, D&d)
  {
    return typename nt2::make_functor<tag::solve_lse_ip_, A>::type()(a, b, c, d, x);
  }
