...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 linalg toolbox - sv"
...
NT2_TEST_CASE_TPL ( sv, NT2_REAL_TYPES) 
{
  ...
  typedef typename make_container<nt2::tag::table_, long int, of_size_<M>  >::type table_type_i;  
  table_type_a a;
  table_type_b b;
  table_type_c c;
  table_type_x x;
