 ...
 *     meta::call<tag::gemm_(A0,A1,A2,A3,A4)>::type
 *     gemm(A0& a0, const A1 & a1, const A2 & a2,
...
namespace nt2 { namespace tag
  {         
    ...
    **/
    struct general_gemm_ : ext::unspecified_<general_gemm_> { typedef ext::unspecified_<general_gemm_> parent; };
  }
  NT2_FUNCTION_IMPLEMENTATION_SELF(tag::general_gemm_, general_gemm, 6)
