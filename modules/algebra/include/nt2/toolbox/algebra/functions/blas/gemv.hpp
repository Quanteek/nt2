                                  ...
                                  )
    {
                                              ...
                                              )
      {
        ...
        BOOST_ASSERT_MSG( (is_vector(x) && is_column(y)), 
                          "Matrix-vector product y = al*A°*x+be*y (gemv) must be called\
                           with vector x and column vector y");
