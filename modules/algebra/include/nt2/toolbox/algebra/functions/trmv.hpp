 ...
 * \file
**/
#ifndef NT2_TOOLBOX_ALGEBRA_FUNCTIONS_TRMV_HPP_INCLUDED
#define NT2_TOOLBOX_ALGEBRA_FUNCTIONS_TRMV_HPP_INCLUDED

#include <nt2/include/functor.hpp>

/*!
 * \ingroup algebra
 * \defgroup algebra_trmv trmv
 *
 * \par Description
 ...
 * 
 * \synopsis
 *     matrix product encapsulasion of blas (dszc)trmv
 *    y <- A°x°
 ...
 *   void gemm(const trmv_status& gs,
 ...
 *
 * In call with status case: the first parameter gs is simply nt2::trmv_status<transa,transx>()
 *
...
namespace nt2 { namespace tag
  {         
    /*!
     * \brief Define the tag trmv_ of functor trmv 
     *        in namespace nt2::tag for toolbox algebra
    **/
    struct trmv_ : ext::unspecified_<trmv_> { typedef ext::unspecified_<trmv_> parent; };
  }
  ...
  trmv(A5 const& a5, A0 const& a0, A1 & a1)
  {
    typename nt2::make_functor<tag::trmv_, A0>::type()(a5, a0, a1);
  }

  template < char transa, char transx, char upload, char diag,
             class A0, class A1, class A2>
  BOOST_FORCEINLINE void trmv(A0 const& a0, A1& a1)
  {
    trmv(trmv_status<transa, transx, upload, diag>(), a0, a1);
  }
}
