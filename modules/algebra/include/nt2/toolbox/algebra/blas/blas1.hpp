...
extern "C"
{
  ...
  float F77NAME(sasum)(const long int *n, const float *dx, const long int *incx);
  
  
  void F77NAME(saxpy)(const long int *n, const float *da, const float *dx, 
                      const long int *incx, float *dy, const long int *incy);
  
  void F77NAME(scopy)(const long int *n, float *dx, const long int *incx, float *dy, 
                      const long int *incy);
  
  
  float F77NAME(sdot)(const long int *n, const float *dx, const long int *incx, 
                      const float *dy, const long int *incy);
  
  float F77NAME(snrm2)(const long int *n, const float *dx, const long int *incx); 
  
  void F77NAME(srot)(const long int *n, float *dx, const long int *incx, float *dy, 
                     const long int *incy, const float *c, const float *s);
  
  void F77NAME(srotg)(float *da, float *db, float *c, float *s);
  
  void F77NAME(sscal)(const long int *n, float *da, float *dx, const long int *incx);
  
  void F77NAME(sswap)(const long int *n, float *dx, const long int *incx, float *dy, 
                      const long int *incy);
  
  long int F77NAME(isamax)(const long int *n, const float *dx, const long int *incx);
...
#define NT2_WRAP_COMPLEX void
  ...
  void F77NAME(caxpy)(const long int *n, const NT2_WRAP_COMPLEX *da, 
  ...
  void F77NAME(zaxpy)(const long int *n, const NT2_WRAP_COMPLEX *da, 
                      const NT2_WRAP_COMPLEX *dx, 
                      const long int *incx, NT2_WRAP_COMPLEX *dy, 
                      const long int *incy);
