...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 algebra toolbox - mm"
...
#include <nt2/include/functions/b_mm.hpp>
...
NT2_TEST_CASE_TPL ( mm, NT2_REAL_TYPES) 
{
  ...
  typedef typename make_container<nt2::tag::table_, T, of_size_<M, P>  >::type table_type_b;
  typedef typename make_container<nt2::tag::table_, T, of_size_<M, P> >::type table_type_r;
  table_type_a a;
  table_type_b b;
  table_type_r r;
  table_type_r r_;
...

  {
    ...
    // Call blas
    nt2::b_mm(nt2::blas_status<nt2::blas_types::general>(), a, b, r_);
  ...
  }
  {
    ...
    std::cout << " ==================================================== " << std::endl; 
    // Call blas
    nt2::b_mm(nt2::blas_status<nt2::blas_types::symetric>(), a, b, r_);
